       ...
       {isChatOpen && navWorkspace === 'team' && (
         <>
           ...
           <motion.div 
             ...
             // --- FIX: Removed arbitrary borders that cause 1px gaps and aligned padding perfectly ---
           ...
           >
             ...
             {/* --- FIX: Added pb-6 padding so the input box doesn't hug the bottom of the screen --- */}
